        ...
        >
          ...
          <div className="flex flex-col gap-4 about-text">
            <p className="card-body" style={{ color: 'var(--color-text-primary)' }}>
              I am Amresh Baskar, a Full Stack Developer with hands-on experience in React.js, Node.js, and AWS. I founded Pearl Cloud Solutions, a home-based venture through which I build SaaS products and web applications, and I'm now looking for a full-time full stack developer role where I can grow within a team.
            </p>
